describe 'OLA - Student Loan Products', loan_type: 'medical', loan_type_code: 'GRMD', page_type: 'form', order: :defined do
  ...
  describe "Medical Form" do
    it "exists for following tests to use, otherwise they are skipped", :smoke do
      goto_page_ola loans.loan_type_id.medical_loan
      expect(find p.globals.main_form).to be
    end
  end

  describe "Medical General Information Page - First Name Left Blank" do
    it "has a general information page for medical student loans that is filled out incorrectly", :sad do
      goto_page_ola loans.loan_type_id.medical_loan
  ...
  describe "Medical Loan Form School Information Page - Degree Left blank" do
    it "has a school information page for medical student loans that is filled out incorrectly", :sad, :api do
      create_loan_using_api_and_continue_to_school_info p, loans.loan_type.medical_school
      ...
      expect(find_by_id(p.school_information.major).value).to eq 'MED'
  ...
  describe "Medical Loan Happy All Pages" do
    it "has a form for medical student loans that is filled out correctly", :happy do
      goto_page_ola loans.loan_type_id.medical_loan
      ssn = DynamoActions.increment_ssn
      fill_out_basic_information_form p, ssn
      confirm_date_of_birth p
